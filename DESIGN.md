...
- Imagen drafts: orchestration evidence: `concept-a-workbench.png` / `concept-b-run-detail.png`. Concept A governs the ScenarioWorkbench workbench density and topology-plus-evidence composition. Concept B governs RunDetail side navigation, ledger panel, and proposed patch inspection.
